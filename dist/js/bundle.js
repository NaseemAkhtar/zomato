...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ../config */ \"./src/js/config.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Search = function () {\n    function Search(query) {\n        _classCallCheck(this, Search);\n\n        this.query = query;\n    }\n\n    _createClass(Search, [{\n        key: 'getResults',\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(city, categoryID) {\n                var settings, fetchcategory, resCategory, restaurentURL, restaurentInfo, restaurentJSON, cityID;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                settings = {\n                                    method: 'GET',\n                                    headers: {\n                                        'user-key': _config.key,\n                                        'Content-Type': 'application/json'\n                                    }\n                                };\n                                _context.prev = 1;\n                                _context.next = 4;\n                                return fetch('https://developers.zomato.com/api/v2.1/categories', settings);\n\n                            case 4:\n                                fetchcategory = _context.sent;\n                                _context.next = 7;\n                                return fetchcategory.json();\n\n                            case 7:\n                                resCategory = _context.sent;\n\n                                this.getCategory = resCategory.categories;\n\n                                restaurentURL = _config.proxy + 'https://developers.zomato.com/api/v2.1/search?entity_id=' + cityID + '&entity_type=city&category=' + categoryID + '&sort=rating';\n                                _context.next = 12;\n                                return fetch(restaurentURL, settings);\n\n                            case 12:\n                                restaurentInfo = _context.sent;\n                                _context.next = 15;\n                                return restaurentInfo.json();\n\n                            case 15:\n                                restaurentJSON = _context.sent;\n                                _context.next = 18;\n                                return restaurentJSON.restaurants;\n\n                            case 18:\n                                this.restaurent = _context.sent;\n                                cityID = 0;\n\n                                if (this.restaurent.length > 0) {\n                                    cityID = this.restaurent[0].restaurant.location.city_id;\n                                }\n\n                                _context.next = 26;\n                                break;\n\n                            case 23:\n                                _context.prev = 23;\n                                _context.t0 = _context['catch'](1);\n\n                                console.log(_context.t0);\n\n                            case 26:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[1, 23]]);\n            }));\n\n            function getResults(_x, _x2) {\n                return _ref.apply(this, arguments);\n            }\n\n            return getResults;\n        }()\n    }]);\n\n    return Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./src/js/models/Search.js?");
